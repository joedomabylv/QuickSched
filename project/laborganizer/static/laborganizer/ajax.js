            ...
            '<a href="" id="switch" class="list-group-item list-group-item-action switch '+ response[key].score_color + '"> \
              ...
              <div class="col"> \
                <div class="d-flex justify-content-center p-2"> \
                  ' + response[key].to_ta + ' (' + response[key].to_lab + ') <br /> Unfit score: ' + response[key].st_score + ' \
                </div> \
                ...
                <div class="d-flex justify-content-center p-2"> \
                  ' + response[key].from_ta + ' (' + response[key].from_lab + ') <br /> Unfit score: ' + response[key].pt_score + ' <br /> <br /> Total Deviation Score: ' + response[key].deviation_score + '\
                </div> \
              </div> \
            </div> \
              </a>'
