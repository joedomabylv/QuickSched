...
class TemplateSchedule(models.Model):
    ...
    """Function: check is a lab has an assignment """
    """This is terrible, I will change this later"""
    ...
    def initialize(self, tas, labs):
        ...
        while not self.all_labs_have_assignment(labs):
            ...
            for lab in labs:
                #find a list of the highest scoring tas for a lab(if the are multiple tas with the highest score)
                ...
                while not self.lab_has_an_assignment(lab):
                    ...
                    if self.lab_has_an_assignment(lab) == False:
                        for ta in highest_scoring_tas:
                            # if TA already assigned to a lab that is different then the current lab
                            ...
                            # Get scores for both labs
                                ...
                                # if ta score for current lab is greater then lab they are being placed
                    ...
                    # If the end of loop is reached and the lab still doesn't have an assignment
                    # generate a new highest scoring ta list with all old highest scores removed
                    ...
                    # End of loop until lab is assigned

            # End of loop through all the labs

        #End of loop until all until all tas are assigned to a lab
        ...
        for lab in labs:
            ...
            if len(highest_scoring_tas) > 0:
                ...
                # #assigning best scoring tas regardless of if they are already assigned or not
                if not self.lab_has_an_assignment(lab):
                    self.assign(highest_scoring_tas[0], lab)
